...
const SvgButton = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    viewBox="0 0 360 87"
        style={{
      // @ts-ignore
      enableBackground: "new 0 0 360 87",
    }}
    xmlSpace="preserve"
    width="1em"
    height="1em"
